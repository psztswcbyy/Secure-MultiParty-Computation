...
%         maxEp = 0;
        ...
        for i = 1:Num_SingleTest
            ...
            [Va, Vb, Vc, A_result, B_result, C_result, Re_Err_result, Ab_Err_result, MRE_result, ...
                MAPE_result, SAPE_result, F_norm, Theory_result, Real_result] =...
                Secure_3x2PMP(A, B, C);
...
filename = strcat('【Ep=(', num2str(minEp),',',num2str(maxEp),')Dim=(',...
    num2str(DimMin),',',num2str(DimMax),')】S3x2PMP_ExperimentResults.xlsx');
