...
[A, Ra, A_hat] = RandMatrixGen3(N, minEp, maxEp, FirstNumMin, FirstNumMax);
[B, Rb, B_hat] = RandMatrixGen3(N, minEp, maxEp, FirstNumMin, FirstNumMax);
[C, Rc, C_hat] = RandMatrixGen3(N, minEp, maxEp, FirstNumMin, FirstNumMax);
% ============================================================================================================================
...
[ra, ~, Va] = RandMatrixGen3(N, minEp, maxEp, FirstNumMin, FirstNumMax);
Ta = Ma + Sa - Va - ra;
t1 = Ra * B1;
% ============================================================================================================================
% 7.Carol计算t2发给Bob
...
[rb, ~, Vb] = RandMatrixGen3(N, minEp, maxEp, FirstNumMin, FirstNumMax);
rc = Ra * Rb * Rc - ra - rb;
Sb = t1 * t2;
Tb = Ta + Sb - Mb - Vb - rb;
% ============================================================================================================================
