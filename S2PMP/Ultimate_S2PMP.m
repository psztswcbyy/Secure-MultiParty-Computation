...
% 对称区间测试案例EpMin=-16,EpMax = 16;EpUnit = 1;maxEp = EpMin:EpUnit:EpMax;minEp = -maxEp;j = (maxEp-EpMin)/EpUnit + 1;
...
filename = strcat('【Ep=(', num2str(minEp),',',num2str(maxEp),')Dim=(',...
    num2str(DimMin),',',num2str(DimMax),')】S2PMP_ExperimentResults.xlsx');
