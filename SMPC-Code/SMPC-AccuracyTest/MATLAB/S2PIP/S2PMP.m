% ============================================================================================================================
% 【功能说明】S2PMP函数用于实现安全两方矩阵乘法协议，涉及到的输入参数包含参与方Alice输入矩阵A和参与方Bob输入矩阵B；涉及到的输
% 出参数包含第一参与方Alice的输出矩阵Va，第二参与方Bob的输出矩阵Vb，两方矩阵乘法结果的相对误差矩阵Re_Err_result，两方矩阵乘法
% 结果的绝对误差矩阵Ab_Err_result，乘法结果的最大相对误差结果MRE_result，乘法结果的均值绝对百分比误差MAPE_result，乘法结果的
