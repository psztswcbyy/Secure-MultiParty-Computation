...
%         step = (N - DimMin)/DimUnit * Num_Ep + (minEp - EpMin)/EpUnit+1;
        ...
        for i = 1:Num_SingleTest
            ...
            [Va, Vb, Vc, A1_result, A2_result, B1_result, B2_result, C_result, Re_Err_result, Ab_Err_result, ...
                MRE_result, MAPE_result, SAPE_result, F_norm, Theory_result, Real_result, Error_Rate] = S3PHMP(A1, A2, B1, B2, C);
...
filename = strcat('【Ep=(', num2str(minEp),',',num2str(maxEp),')Dim=(',...
    num2str(DimMin),',',num2str(DimMax),')】S3PHMP_ExperimentResults.xlsx');
